  ...
  Widget build(BuildContext context) {
    if (questions.isEmpty) {
      return Scaffold(
        appBar: AppBar(
          title: Text('Quiz'),
          backgroundColor: Color(0xFF8B4513), // Darker Brown
        ),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        foregroundColor: Color.fromARGB(255, 247, 246, 246), // Darker Brown
      ),
      body: Padding(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                ...
                color: Color(
                    0xFF4E3629), // Slightly lighter brown for question text
              ),
            ),
            SizedBox(height: 20),
              ...
              return Padding(
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color(0xFF8B4513), // Dark Brown for button
                    foregroundColor:
                        Colors.white, // White text on brown background
            ...
            LinearProgressIndicator(
              ...
              backgroundColor: Color.fromARGB(0, 255, 255,
                  255), // Lighter brown background for the progress bar
              color: Color(
                  0xFF8B4513), // Dark Brown for the progress bar indicator
            ),
          ],
        ),
      ),
